...
class simulTestCase(unittest.TestCase):
    ...
    def test_model_tree_markov_full(self):
        ...
        C, y, z, pi, mu, tau, eps = unconditioned_model(data, n_cells, n_sites, n_copy_states, tree, mu_0, lmbda_0, alpha0, beta0, a0, b0, dir_alpha0)
    ...
    def test_simulate_full_dataset(self):
        ...
        a0 = 10.
        b0 = 40.
        dir_alpha0 = torch.tensor([1., 3., 3.])
        config = Config(n_nodes=n_nodes, n_cells=n_cells, chain_length=n_sites, n_states=n_copy_states)
        output_sim = simulate_full_dataset(config, eps_a=a0, eps_b=b0, mu0=mu_0, lambda0=lmbda_0, alpha0=alpha0, beta0=beta0,
